      ...
      <div>
        <div
          ...
          <div className={priorityGuideOpen ? styles.active : styles.inactive}>
            ...
            <p>
              <strong className={styles.s2}>S2</strong> <strong>Serious</strong>
              : Major functionality/product severely impaired or a high impact
              issue and a satisfactory workaround does not exist.
            </p>

            <p>
              <strong className={styles.s3}>S3</strong> <strong>Normal</strong>:
              Blocks non-critical functionality and a work around exists.
            </p>

            <p>
              <strong className={styles.s4}>S4</strong> <strong>Trivial</strong>

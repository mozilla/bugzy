  ...
  renderBugs(bugs) {
    ...
    return (
      <React.Fragment>
        ...
        <p>
          This is the set of bugs we will complete before Firefox 67 merges to
          beta / 66 merges to release.
        </p>
        <CompactBugList
        ...
        <CompactBugList
          ...
          bugs={bugsByRelease.nightlyReadyForExport}
        />
        <CompactBugList
        ...
        />
        <CompactBugList
          subtitle="Exported bugs"
          bugs={bugsByRelease.nightlyExported}
        />
        <CompactBugList
          subtitle="Verified bugs"
          bugs={bugsByRelease.nightlyVerified}
        />
